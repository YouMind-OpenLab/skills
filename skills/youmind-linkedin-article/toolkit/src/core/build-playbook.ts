 ...
 *   npx tsx src/build-playbook.ts --client demo --project-dir /path/to/skill --verbose
 */
...
function main() {
  ...
  const corpusDir = resolve(projectDir, 'clients', client, 'corpus');
  ...
  console.log();
  console.log(`Save results to: ${resolve(projectDir, 'clients', client, 'playbook.md')}`);
}
